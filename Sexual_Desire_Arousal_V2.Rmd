...
### Table \@ref(tab:ab-m-stimuli-content). ANOVA-type table for the effects of stimuli content, gender and stimuli content on Subjective sexual arousal
...
```{r tab-m-stimuli-content, message = FALSE, cache = TRUE}
...
anova.sig.lmer(model = m_stim_cont, custom_caption = "Effects of relationship type and gender 
