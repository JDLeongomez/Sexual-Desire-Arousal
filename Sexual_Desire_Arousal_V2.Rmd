...
We fitted and checked model fitness of both the original (proportion; `m1a_prop`) and transformed (normalized; `m1a_norm`) TSD scores
...
plot(check_model(m1a_prop)) +
  labs(title = "Original (proportion) Solitary TSD")

ggarrange(ggarrange(plotlist = plot(check_model(m1a_prop, 
                                                panel = FALSE,
                                                check = c("pp_check",
                                                          "linearity", 
                                                          "homogeneity", 
                                                          "qq"))),
                    ncol = 1, nrow = 4),
          ggarrange(plotlist = plot(check_model(m1a_norm, 
                                                panel = FALSE,
                                                check = c("pp_check",
                                                          "linearity", 
                                                          "homogeneity", 
