...
dat_m2_clmm <- dat_m2 |>
  ...
  mutate(Gender = as.factor(Gender),
         Stimuli.sex = as.factor(Stimuli.sex),
         Subjective.sexual.arousal = as.factor(Subjective.sexual.arousal)) 

m2a_clmm <- clmm(Subjective.sexual.arousal ~ 
...
p_m2a_clmm <- emmeans(m2a_clmm, ~ Solitary.sexual.desire | Gender * Stimuli.sex,
  ...
  geom_ribbon(aes(ymin = asymp.LCL, ymax = asymp.UCL), alpha = 0.2) +  # CIs
...
ggarrange(p_m2a_clmm, p_m2a_lmer, p_m2a_poisson,
          common.legend = TRUE,
          labels = "auto",
          legend = "right",
          nrow = 1)
...
```{r}
anova.sig.lmer(model = m2a_lmer, 
               custom_caption = "Effects of Solitary sexual desire, Stimuli sex, and gender 
