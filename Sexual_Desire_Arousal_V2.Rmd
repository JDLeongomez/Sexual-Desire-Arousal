...
anova.comp <- function(CLMMmod, GLMERmod, LMERmod, hypothesis) {
  compTab <- 
    ...
    kable(
      ...
      digits = 3,
      linesep = "",
      caption = paste0("Comparison of fixed effects across the three models for Hypothesis ", 
...
```{r fig-m1-fin, results = "hold", fig.height = 4.5, fig.cap = "Effects of gender and relationship type on dimensions of sexual desire. Solitary sexual desire was transformed using ordered quantile normalization [@petersonOrderedQuantileNormalization2020a]. **(a)** Solitary trait sexual desire; **(b)** Dyadic trait sexual desire (Attractive person); **(c)** Dyadic trait sexual desire (Partner). Dots and bars represent estimated marginal means and 95% CI. In all cases, significant effects are represented with lines and stars: \\**p* < 0.05, \\*\\**p* < 0.01, \\*\\*\\**p* < 0.001, \\*\\*\\*\\**p* < 0.0001.", warning = FALSE, message = FALSE}
