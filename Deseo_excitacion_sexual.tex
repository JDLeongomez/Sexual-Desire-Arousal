...
\midrule
Women & 16.85 & 0.44 & 320.83 & 15.86 & 17.84 & Women - Men & -4.26 & 0.67 & 319.63 & -6.4 & \textbf{< 0.0001}\\
Men & 21.11 & 0.50 & 318.72 & 19.98 & 22.23 &  &  &  &  &  & \\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\NormalTok{h1a }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(dat.comp, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Gender, }\AttributeTok{y =} \StringTok{\textasciigrave{}}\AttributeTok{Sexual desire}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{color =}\NormalTok{ Gender)) }\SpecialCharTok{+}
  ...
  \FunctionTok{stat\_pvalue\_manual}\NormalTok{(t.m1a, }
                     ...
                     \AttributeTok{y.position =} \DecValTok{40}\NormalTok{, }
...
\NormalTok{h1b }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(dat.comp, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Dimension, }\AttributeTok{y =} \StringTok{\textasciigrave{}}\AttributeTok{Sexual desire}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{color =}\NormalTok{ Dimension)) }\SpecialCharTok{+}
  \FunctionTok{geom\_violin}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_jitter}\NormalTok{(}\AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{, }\AttributeTok{width =} \FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
...
\NormalTok{h1c }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(dat.comp, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Relationship, }\AttributeTok{y =} \StringTok{\textasciigrave{}}\AttributeTok{Sexual desire}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{color =}\NormalTok{ Relationship)) }\SpecialCharTok{+}
  \FunctionTok{geom\_violin}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_jitter}\NormalTok{(}\AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{, }\AttributeTok{width =} \FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+}
...
\emph{TH.data(v.1.1-1)}, \emph{minqa(v.1.2.5)}, \emph{colorspace(v.2.1-0)}, \emph{ggsignif(v.0.6.4)}, \emph{htmlTable(v.2.4.1)}, \emph{estimability(v.1.4.1)}, \emph{base64enc(v.0.1-3)}, \emph{parameters(v.0.20.2)}, \emph{rstudioapi(v.0.14)}, \emph{farver(v.2.1.1)}, \emph{MatrixModels(v.0.5-1)}, \emph{fansi(v.1.0.4)}, \emph{mvtnorm(v.1.1-3)}, \emph{xml2(v.1.3.3)}, \emph{codetools(v.0.2-19)}, \emph{splines(v.4.2.3)}, \emph{mnormt(v.2.1.1)}, \emph{Formula(v.1.2-5)}, \emph{jsonlite(v.1.8.4)}, \emph{nloptr(v.2.0.3)}, \emph{broom(v.1.0.4)}, \emph{cluster(v.2.1.4)}, \emph{compiler(v.4.2.3)}, \emph{httr(v.1.4.5)}, \emph{backports(v.1.4.1)}, \emph{fastmap(v.1.1.1)}, \emph{cli(v.3.6.1)}, \emph{quantreg(v.5.94)}, \emph{admisc(v.0.31)}, \emph{htmltools(v.0.5.5)}, \emph{tools(v.4.2.3)}, \emph{coda(v.0.19-4)}, \emph{gtable(v.0.3.3)}, \emph{glue(v.1.6.2)}, \emph{Rcpp(v.1.0.10)}, \emph{cellranger(v.1.1.0)}, \emph{vctrs(v.0.6.1)}, \emph{svglite(v.2.1.1)}, \emph{nlme(v.3.1-162)}, \emph{insight(v.0.19.1)}, \emph{xfun(v.0.38)}, \emph{rvest(v.1.0.3)}, \emph{timechange(v.0.2.0)}, \emph{lifecycle(v.1.0.3)}, \emph{hms(v.1.1.3)}, \emph{parallel(v.4.2.3)}, \emph{sandwich(v.3.0-2)}, \emph{SparseM(v.1.81)}, \emph{expm(v.0.999-7)}, \emph{yaml(v.2.3.7)}, \emph{curl(v.5.0.0)}, \emph{see(v.0.7.5)}, \emph{gridExtra(v.2.3)}, \emph{rpart(v.4.1.19)}, \emph{stringi(v.1.7.12)}, \emph{highr(v.0.10)}, \emph{bayestestR(v.0.13.0)}, \emph{checkmate(v.2.1.0)}, \emph{boot(v.1.3-28.1)}, \emph{rlang(v.1.1.0)}, \emph{pkgconfig(v.2.0.3)}, \emph{systemfonts(v.1.0.4)}, \emph{evaluate(v.0.20)}, \emph{lattice(v.0.20-45)}, \emph{patchwork(v.1.1.2)}, \emph{htmlwidgets(v.1.6.2)}, \emph{labeling(v.0.4.2)}, \emph{cowplot(v.1.1.1)}, \emph{tidyselect(v.1.2.0)}, \emph{magrittr(v.2.0.3)}, \emph{bookdown(v.0.33)}, \emph{R6(v.2.5.1)}, \emph{generics(v.0.1.3)}, \emph{multcomp(v.1.4-23)}, \emph{mgcv(v.1.8-42)}, \emph{foreign(v.0.8-84)}, \emph{pillar(v.1.9.0)}, \emph{withr(v.2.5.0)}, \emph{jtools(v.2.2.1)}, \emph{nnet(v.7.3-18)}, \emph{datawizard(v.0.7.0)}, \emph{survival(v.3.5-3)}, \emph{abind(v.1.4-5)}, \emph{crayon(v.1.5.2)}, \emph{Quandl(v.2.11.0)}, \emph{utf8(v.1.2.3)}, \emph{tzdb(v.0.3.0)}, \emph{rmarkdown(v.2.21)}, \emph{grid(v.4.2.3)}, \emph{data.table(v.1.14.8)}, \emph{digest(v.0.6.31)}, \emph{webshot(v.0.5.4)}, \emph{xtable(v.1.8-4)}, \emph{numDeriv(v.2016.8-1.1)}, \emph{munsell(v.0.5.0)}, \emph{viridisLite(v.0.4.1)} and \emph{quadprog(v.1.5-8)}
