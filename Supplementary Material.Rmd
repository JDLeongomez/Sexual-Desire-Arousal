...
author:
  ...
  - name: Juan David Leongómez \orcidlink{0000-0002-0092-6298}
    ...
    institute: [ueb]
institute:
  - ueb: 'Faculty of Psychology, Universidad El Bosque, Bogota 110121, Colombia.'
...
m3a_clmm <- clmm(
  Subjective.sexual.arousal.factor ~ Solitary.TSD * Gender * Relationship +
    # (1 | Stimuli.code) + # Random intercept for Stimuli impeded convergence
    (1 | Participant), # Random intercept for Participant
  data = dat_m3,
  link = "probit",
  control = list(method = "nlminb") # Optimiser that often helps convergence
)
