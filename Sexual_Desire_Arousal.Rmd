...
ctl_SSD <- lm(`Solitary sexual desire` ~ 
                `Relationship duration` + scale(`MGSS sexual satisfaction (Partner)`),
              data = dat_ctl)
...
ctl_PD_fin <- lm(`Dyadic sexual desire (Partner)` ~ scale(`MGSS sexual satisfaction (Partner)`),
              data = dat_tl_PD_fin)
...
dat <- dat |> 
  ...
  rows_update(dat_ctl, by = "Participant", unmatched = "ignore")
```
