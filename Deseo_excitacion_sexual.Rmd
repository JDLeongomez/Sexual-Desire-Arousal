...
h1b <- ggplot(dat.comp, aes(x = Dimension, y = `Sexual desire`, color = Dimension)) +
  geom_violin() +
  geom_jitter(alpha = 0.3, width = 0.1) +
...
h1c <- ggplot(dat.comp, aes(x = Relationship, y = `Sexual desire`, color = Relationship)) +
  geom_violin() +
  geom_jitter(alpha = 0.3, width = 0.1) +
