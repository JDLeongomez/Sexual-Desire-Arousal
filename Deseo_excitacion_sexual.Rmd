...
```{r tab-m2a-emms-c, message = FALSE, warning = FALSE}
...
```{r fig-h2a, results = "hold", fig.height = 12, fig.cap = "Subjective sexual arousal to erotic stimuli: Significant main effects and interactions of model 2A. For detailed results of the model, see Table \\@ref(tab:tab-m2a). **(a)** Main effect of Solitary sexual desire on Subjective sexual arousal (for detailed results, see Table \\@ref(tab:tab-m2a)); **(b)** main effect of Dyadic sexual desire (Attractive person) on Subjective sexual arousal  (for detailed results, see Table \\@ref(tab:tab-m2a)); **(c)** interaction between Stimuli sex and gender (significant effects of stimuli sex by participant gender are represented with lines and stars. White dots and black bars represent estimated marginal means and 95% CI, calculated from 1000 bootstraped simulations; for detailed results, see Table \\@ref(tab:tab-m2a-emms-c)); **(d)** interaction between Stimuli sex and Dyadic sexual desire (Attractive person) (for detailed results, see Table \\@ref(tab:tab-m2a-slo-d)); **(e)** interaction between Stimuli sex, gender and Dyadic sexual desire (Attractive person) (for detailed results, see Table \\@ref(tab:tab-m2a-slo-e)); **(f)** interaction between Relationship, gender and Dyadic sexual desire (Partner) (for detailed results, see Table \\@ref(tab:tab-m2a-slo-f)); **(g)** interaction between Relationship, Stimuli sex and Dyadic sexual desire (Partner) (for detailed results, see Table \\@ref(tab:tab-m2a-slo-g)). *Women* and *Men* refer to the gender of the participants and *Female* and *Male* to the sex of the stimuli. To better represent the associations between predictor variables and subjective sexual arousal within the model (i.e. when including all other effects), in all cases the *Y* axis represents values predicted by the model instead of raw values. For statistical significance, \\**p* < 0.05, \\*\\**p* < 0.01, \\*\\*\\**p* < 0.001, \\*\\*\\*\\**p* < 0.0001.", warning = FALSE, message = FALSE}
...
p2a.a <- ggplot(m2a.dat, aes(x = `Solitary sexual desire (C)`, 
...
p2a.b <- ggplot(m2a.dat, aes(x = `Dyadic sexual desire (Attractive person) (C)`, 
                             y = `Subjective sexual arousal (p)`)) +
  geom_jitter(alpha =  0.01) +
  geom_smooth(method = "lm") +
  labs(y = " \n ")  +
...
p2a.c <- ggplot(m2a.dat, aes(x = `Stimuli sex`, 
                             y = `Subjective sexual arousal (p)`, 
                             color = `Stimuli sex`)) +
  geom_violin() +
...
p2a.d <- ggplot(m2a.dat, aes(x = `Dyadic sexual desire (Attractive person) (C)`,
  ...
  geom_text(data = slop.m2a_d.tab_f,
            ...
            label = paste("B = ", slop.m2a_d.tab_f$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_d.tab_f$sig), "", slop.m2a_d.tab_f$sig)),
  ...
  geom_text(data = slop.m2a_d.tab_m,
            ...
            label = paste("B = ", slop.m2a_d.tab_m$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_d.tab_m$sig), "", slop.m2a_d.tab_m$sig)),
...
slop.m2a_e.tab_m <- filter(slop.m2a_e.tab, `Stimuli sex` == "Male") |>
  mutate(p = pval.lev2(p))
## Plot
p2a.e <- ggplot(m2a.dat, aes(x = `Dyadic sexual desire (Attractive person) (C)`,
                             y = `Subjective sexual arousal (p)`,
                             color = `Stimuli sex`, fill = `Stimuli sex`)) +
  geom_jitter(alpha = 0.01, size = 1, width = 0.4) +
  geom_smooth(method = "lm", fullrange = TRUE) +
  ...
  geom_text(data = slop.m2a_e.tab_f,
            ...
            label = paste("B = ", slop.m2a_e.tab_f$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_e.tab_f$sig), "", slop.m2a_e.tab_f$sig)),
  ...
  geom_text(data = slop.m2a_e.tab_m,
            ...
            label = paste("B = ", slop.m2a_e.tab_m$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_e.tab_m$sig), "", slop.m2a_e.tab_m$sig)),
...
p2a.f <- ggplot(m2a.dat, aes(x = `Dyadic sexual desire (Partner) (C)`,
  ...
  geom_text(data = slop.m2a_f.tab_sta,
            ...
            label = paste("B = ", slop.m2a_f.tab_sta$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_f.tab_sta$sig), "", slop.m2a_f.tab_sta$sig)),
  ...
  geom_text(data = slop.m2a_f.tab_sin,
            ...
            label = paste("B = ", slop.m2a_f.tab_sin$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_f.tab_sin$sig), "", slop.m2a_f.tab_sin$sig)),
...
slop.m2a_g.tab_sin <- filter(slop.m2a_g.tab, Relationship == "Single") |>
  mutate(p = pval.lev2(p))
## Plot
p2a.g <- ggplot(m2a.dat, aes(x = `Dyadic sexual desire (Partner) (C)`,
                             y = `Subjective sexual arousal (p)`,
                             color = Relationship, fill = Relationship)) +
  geom_jitter(alpha = 0.01, size = 1, width = 0.4) +
  geom_smooth(method = "lm", fullrange = TRUE) +
  ...
  geom_text(data = slop.m2a_g.tab_sta,
            ...
            label = paste("B = ", slop.m2a_g.tab_sta$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_g.tab_sta$sig), "", slop.m2a_g.tab_sta$sig)),
            color = color.Relationship[1], size = 2.5) +
  geom_text(data = slop.m2a_g.tab_sin,
            ...
            label = paste("B = ", slop.m2a_g.tab_sin$Coefficient, 
                          ...
                          ifelse(is.na(slop.m2a_g.tab_sin$sig), "", slop.m2a_g.tab_sin$sig)),
            color = color.Relationship[2], size = 2.5) +
  labs(y = " \n ")  +
  theme_tq()

# Full figure for hypothesis 2a
p2af <- ggarrange(ggarrange(ggarrange(p2a.a, p2a.b,
                                      nrow = 1,
                                      labels = "auto"), 
                            p2a.c,
                            labels = c(" ", "c"),
                            nrow = 2), 
                  ggarrange(ggarrange(p2a.d, p2a.e,
                                      nrow = 1,
                                      labels = c("d", "e"),
                                      common.legend = TRUE,
                                      legend = "bottom"),
                            ggarrange(p2a.f, p2a.g,
                                      nrow = 1,
                                      labels = c("f", "g"),
                                      common.legend = TRUE,
                                      legend = "bottom"),
...
```{r tab-m2b-emms-b, message = FALSE, warning = FALSE}
emms.m2b_b <- emmeans(m2b, ~ factor(`Stimuli sex`) | Gender,
                    adjust = "bonferroni") #asymptotic degrees of freedom

emms.m2b_b.tab <- tibble(data.frame(emms.m2b_b)) |>
  rename("Stimuli sex" = Stimuli.sex) |> 
  mutate("Subjective sexual arousal (p)" = emmean)

t.m2b_b <- contr.stars(emms.m2b_b) |> 
  mutate(p.value = pval.lev(p.value))

t.m2b_b.f <- t.m2b_b |> 
  insertRows(2, new = NA)

merge(emms.m2b_b.tab, t.m2b_b.f, by = 0, all = TRUE) |>
  select(-c(1,3,6,9,12,15,18)) |> 
  unite(Contrast, group1, group2, sep = " - ") |>
  mutate_at("Contrast", str_replace_all, "NA - NA", " ") |> 
  kable(digits = 2,
...
Table of estimated slopes for Solitary sexual desire on Subjective sexual arousal for each gender from model 2b. Dyadic sexual desire (Attractive person) values were centered. Slopes were calculated using the `sim_slopes` function from the `interactions` package [@interactionscit].
...
Table of estimated slopes for Solitary sexual desire on Subjective sexual arousal for each stimuli sex from model 2b. Dyadic sexual desire (Attractive person) values were centered. Slopes were calculated using the `sim_slopes` function from the `interactions` package [@interactionscit].
...
# # Figure main effect of Dyadic sexual desire (Attractive person) on Subjective sexual arousal
p2b.a <- ggplot(m2b.dat, aes(x = `Dyadic sexual desire (Attractive person) (C)`, 
                             y = `Subjective sexual arousal (p)`)) +
  geom_jitter(alpha =  0.01) +
  geom_smooth(method = "lm") +
  labs(y = "Subjective sexual\narousal (predicted)") +
  geom_text(data = slop.m2b_a.tab[6,],
            mapping = aes(x = -Inf, y =Inf,
                          vjust = 2, hjust = -0.03),
            label = paste("B = ", slop.m2b_a.tab[6,]$Estimate,
                          ", IC 95%[",
                          paste(slop.m2b_a.tab[6,]$X2.5..,
                                slop.m2b_a.tab[6,]$X97.5..,
                                sep = ", "),
                          "], p", slop.m2b_a.tab[6,]$Pr...t.., "****"),
            size = 3) +
  theme_tq()

# Figure interaction between Stimuli sex and gender
p2b.b <- ggplot(m2b.dat, aes(x = `Stimuli sex`, 
                             y = `Subjective sexual arousal (p)`, 
                             color = `Stimuli sex`)) +
  geom_violin() +
  geom_jitter(alpha = 0.01, width = 0.1) +
  ...
  scale_fill_manual(values = color.StimuliSex) +
  facet_wrap(~Gender) +
  geom_errorbar(data = emms.m2b_b.tab, 
                mapping = aes(ymin = asymp.LCL, ymax = asymp.UCL), 
                colour = "black", width = 0.1) +
  geom_point(data = emms.m2b_b.tab, 
             shape = 21, size = 3,
             color = "black", fill = "white") +
  stat_pvalue_manual(t.m2b_b, 
                     label = "p.signif", 
                     y.position = c(7.4,7.8), 
                     tip.length = 0) +
  labs(y = " \n ")  +
...
## Extract data for by stimuli sex
slop.m2b_c.tab_wom <- filter(slop.m2b_c.tab, Gender == "Women") |>
  mutate(p = pval.lev2(p))
slop.m2b_c.tab_men <- filter(slop.m2b_c.tab, Gender == "Men") |>
  mutate(p = pval.lev2(p))
## Plot
p2b.c <- ggplot(m2b.dat, aes(x = `Solitary sexual desire (C)`,
  ...
  scale_color_manual(values = color.Gender) +
  scale_fill_manual(values = color.Gender) +
  geom_text(data = slop.m2b_c.tab_wom,
            mapping = aes(x = -Inf, y = Inf,
            vjust = 2, hjust = -0.03),
            inherit.aes = FALSE,
            label = paste("B = ", slop.m2b_c.tab_wom$Coefficient, 
                          ", IC 95%[", paste(slop.m2b_c.tab_wom$X2.5., 
                                             slop.m2b_c.tab_wom$X97.5., sep = ", "), 
                          "], p", slop.m2b_c.tab_wom$p, 
                          ifelse(is.na(slop.m2b_c.tab_wom$sig), "", slop.m2b_c.tab_wom$sig)),
            color = color.Gender[1], size = 3) +
  geom_text(data = slop.m2b_c.tab_men,
            mapping = aes(x = -Inf, y = Inf,
            vjust = 4, hjust = -0.03),
            inherit.aes = FALSE,
            label = paste("B = ", slop.m2b_c.tab_men$Coefficient, 
                          ", IC 95%[", paste(slop.m2b_c.tab_men$X2.5., 
                                             slop.m2b_c.tab_men$X97.5., sep = ", "), 
                          "], p", slop.m2b_c.tab_men$p, 
                          ifelse(is.na(slop.m2b_c.tab_men$sig), "", slop.m2b_c.tab_men$sig)),
...
## Extract data for by stimuli sex
slop.m2b_d.tab_f <- filter(slop.m2b_d.tab, `Stimuli sex` == "Female") |>
  mutate(p = pval.lev2(p))
slop.m2b_d.tab_m <- filter(slop.m2b_d.tab, `Stimuli sex` == "Male") |>
  mutate(p = pval.lev2(p))
## Plot
p2b.d <- ggplot(m2b.dat, aes(x = `Dyadic sexual desire (Attractive person) (C)`,
                             y = `Subjective sexual arousal (p)`,
                             color = `Stimuli sex`, fill = `Stimuli sex`)) +
  geom_jitter(alpha = 0.01, size = 1, width = 0.4) +
  geom_smooth(method = "lm", fullrange = TRUE) +
  scale_color_manual(values = color.StimuliSex) +
  scale_fill_manual(values = color.StimuliSex) +
  geom_text(data = slop.m2b_d.tab_f,
            mapping = aes(x = -Inf, y = Inf,
            vjust = 2, hjust = -0.03),
            inherit.aes = FALSE,
            label = paste("B = ", slop.m2b_d.tab_f$Coefficient, 
                          ", IC 95%[", paste(slop.m2b_d.tab_f$X2.5., 
                                             slop.m2b_d.tab_f$X97.5., sep = ", "), 
                          "], p", slop.m2b_d.tab_f$p, 
                          ifelse(is.na(slop.m2b_d.tab_f$sig), "", slop.m2b_d.tab_f$sig)),
            color = color.StimuliSex[1], size = 3) +
  geom_text(data = slop.m2b_d.tab_m,
            mapping = aes(x = -Inf, y = Inf,
            vjust = 4, hjust = -0.03),
            inherit.aes = FALSE,
            label = paste("B = ", slop.m2b_d.tab_m$Coefficient, 
                          ", IC 95%[", paste(slop.m2b_d.tab_m$X2.5., 
                                             slop.m2b_d.tab_m$X97.5., sep = ", "), 
                          "], p", slop.m2b_d.tab_m$p, 
                          ifelse(is.na(slop.m2b_d.tab_m$sig), "", slop.m2b_d.tab_m$sig)),
            color = color.StimuliSex[2], size = 3) +
  labs(y = " \n ") +
  theme_tq()
...
# Figure interaction between Stimuli sex, gender and Dyadic sexual desire (Attractive person)
## Extract data for by stimuli sex
slop.m2b_e.tab_f <- filter(slop.m2b_e.tab, `Stimuli sex` == "Female") |>
  mutate(p = pval.lev2(p))
slop.m2b_e.tab_m <- filter(slop.m2b_e.tab, `Stimuli sex` == "Male") |>
  mutate(p = pval.lev2(p))
## Plot
p2b.e <- ggplot(m2b.dat, aes(x = `Dyadic sexual desire (Attractive person) (C)`,
  ...
  scale_fill_manual(values = color.StimuliSex) +
  facet_wrap(~fct_relevel(Gender, "Women", "Men")) +
  geom_text(data = slop.m2b_e.tab_f,
            mapping = aes(x = -Inf, y = Inf,
            vjust = 2, hjust = -0.03),
            inherit.aes = FALSE,
            label = paste("B = ", slop.m2b_e.tab_f$Coefficient, 
                          ", IC 95%[", paste(slop.m2b_e.tab_f$X2.5., 
                                             slop.m2b_e.tab_f$X97.5., sep = ", "), 
                          "], p", slop.m2b_e.tab_f$p, 
                          ifelse(is.na(slop.m2b_e.tab_f$sig), "", slop.m2b_e.tab_f$sig)),
            color = color.StimuliSex[1], size = 2.5) +
  geom_text(data = slop.m2b_e.tab_m,
            mapping = aes(x = -Inf, y = Inf,
            vjust = 4, hjust = -0.03),
            inherit.aes = FALSE,
            label = paste("B = ", slop.m2b_e.tab_m$Coefficient, 
                          ", IC 95%[", paste(slop.m2b_e.tab_m$X2.5., 
                                             slop.m2b_e.tab_m$X97.5., sep = ", "), 
                          "], p", slop.m2b_e.tab_m$p, 
                          ifelse(is.na(slop.m2b_e.tab_m$sig), "", slop.m2b_e.tab_m$sig)),
            color = color.StimuliSex[2], size = 2.5) +
  labs(y = "Subjective sexual\narousal (predicted)") +
  theme_tq()
