...
Table of estimated marginal means and contrasts between stimulus sex for each participant gender. All estimated marginal means and contrasts were calculated using the `emmeans` function from the `emmeans` package [@emmeanscit].

```{r tab-m2a-emms, message = FALSE, warning = FALSE}
...
merge(emms.m2a.tab, t.m2a.f, by = 0, all = TRUE) |>
