...
\urlstyle{same}
\hypersetup{
  pdftitle={Does Trait Sexual Desire Predict Subjective Sexual Response to Erotic Stimuli? Effects of Participant Gender, Stimulus Gender, and Relationship Status among Cisgender Heterosexual Women and Men},
  pdfauthor={Milena Vásquez-Amézquita 2,1,; Marina Begoña Martínez-González 1; Meredith L. Chivers 3; Juan David Leongómez 2},
  colorlinks=true,
  linkcolor={gray},
  filecolor={Maroon},
  citecolor={gray},
...
\author{Milena Vásquez-Amézquita \orcidlink{0000-0001-7317-8430}\textsuperscript{2,1,*} \and Marina Begoña Martínez-González \orcidlink{0000-0002-5840-6383}\textsuperscript{1} \and Meredith L. Chivers \orcidlink{0000-0002-5495-9263}\textsuperscript{3} \and Juan David Leongómez \orcidlink{0000-0002-0092-6298}\textsuperscript{2}}
\date{21 August, 2025}
...
\textsuperscript{2} Faculty of Psychology, Universidad El Bosque, Bogota 110121, Colombia.\\
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/sample-plot-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/density-plot-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/ppc-m1a-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h1a-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/ppc-m1b-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h1b-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/ppc-m1c-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h1c-1.pdf}}
...
\begin{table}[H]
\centering
\caption{\label{tab:tab-m-stimuli-content}Effects of relationship type, gender and stimuli gender on Dyadic TSD Partner}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccc}
...
Stimuli gender & 1, 447 & 96.15 & \textbf{< 0.0001} & 0.18\\
Stimuli content & 1, 363.12 & 86.50 & \textbf{< 0.0001} & 0.19\\
Gender × Stimuli gender & 1, 321 & 471.68 & \textbf{< 0.0001} & 0.59\\
Gender × Stimuli content & 1, 321 & 5.02 & \textbf{0.0257} & 0.01\\
Stimuli gender × Stimuli content & 1, 286.22 & 21.51 & \textbf{< 0.0001} & 0.07\\
Gender × Stimuli gender × Stimuli content & 1, 321 & 116.42 & \textbf{< 0.0001} & 0.26\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Compute estimated marginal means (EMMs) for Stimuli Gender by Stimuli Content \& Gender}
\NormalTok{emms.stim\_cont }\OtherTok{\textless{}{-}} \FunctionTok{emmeans}\NormalTok{(m\_stim\_cont, pairwise }\SpecialCharTok{\textasciitilde{}} \StringTok{\textasciigrave{}}\AttributeTok{Stimuli gender}\StringTok{\textasciigrave{}} \SpecialCharTok{|} \StringTok{\textasciigrave{}}\AttributeTok{Stimuli content}\StringTok{\textasciigrave{}} \SpecialCharTok{+}\NormalTok{ Gender,}
...
\NormalTok{emms.stim\_cont.tab }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(emms.stim\_cont}\SpecialCharTok{$}\NormalTok{emmeans)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{rename}\NormalTok{(}
    ...
    \StringTok{"Stimuli gender"} \OtherTok{=}\NormalTok{ Stimuli.gender}
\NormalTok{  )}
...
\FunctionTok{merge}\NormalTok{(emms.stim\_cont.tab, t.stim\_cont.f, }\AttributeTok{by =} \DecValTok{0}\NormalTok{, }\AttributeTok{all =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{drop\_na}\NormalTok{(}\StringTok{"Stimuli gender"}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \CommentTok{\# Ensure Stimuli gender column is complete}
  \FunctionTok{unite}\NormalTok{(Contrast, group1, group2, }\AttributeTok{sep =} \StringTok{" {-} "}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \CommentTok{\# Create contrast labels}
  \FunctionTok{mutate\_at}\NormalTok{(}\StringTok{"Contrast"}\NormalTok{, str\_replace\_all, }\StringTok{"NA {-} NA"}\NormalTok{, }\StringTok{" "}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \CommentTok{\# Replace missing contrasts}
...
\StringTok{    desire by relationship status"}\NormalTok{,}
    \AttributeTok{escape =} \ConstantTok{FALSE}\NormalTok{,}
    \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}
      \StringTok{"Stimuli gender"}\NormalTok{, }\StringTok{"EMM"}\NormalTok{, }\StringTok{"$SE$"}\NormalTok{, }\StringTok{"$df$"}\NormalTok{, }\StringTok{"$2.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$97.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{,}
...
\multicolumn{6}{c}{ } & \multicolumn{6}{c}{Contrasts} \\
\cmidrule(l{3pt}r{3pt}){7-12}
Stimuli gender & EMM & $SE$ & $df$ & $2.5\% CI$ & $97.5\% CI$ & Contrast & Difference & $SE$ & $df$ & $z$ & $p$\\
\midrule
\addlinespace[0.3em]
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-m-stimuli-content-1.pdf}}
...
Stimuli gender & 1 & 43.812 & \textbf{< 0.0001} & 1 & 31.553 & \textbf{< 0.0001} & 1, 369.21 & 24.715 & \textbf{< 0.0001}\\
Solitary TSD × Gender & 1 & 2.409 & 0.12 & 1 & 2.795 & 0.09 & 1, 319 & 0.852 & 0.36\\
Solitary TSD × Stimuli gender & 1 & 0.137 & 0.71 & 1 & 0.321 & 0.57 & 1, 319 & 0.024 & 0.88\\
Gender × Stimuli gender & 1 & 181.478 & \textbf{< 0.0001} & 1 & 127.568 & \textbf{< 0.0001} & 1, 319 & 74.790 & \textbf{< 0.0001}\\
Solitary TSD × Gender × Stimuli gender & 1 & 2.959 & 0.09 & 1 & 0.605 & 0.44 & 1, 319 & 1.778 & 0.18\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/preds-m2a-1.pdf}}
...
\begin{table}[H]
\centering
\caption{\label{tab:tab-m2a}Effects of Solitary TSD on SSA Across Gender and Stimuli Gender}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccc}
...
Stimuli gender & 1, 369.21 & 24.71 & \textbf{< 0.0001} & 0.06\\
Solitary TSD × Gender & 1, 319 & 0.85 & 0.36 & < 0.0001\\
Solitary TSD × Stimuli gender & 1, 319 & 0.02 & 0.88 & < 0.0001\\
Gender × Stimuli gender & 1, 319 & 74.79 & \textbf{< 0.0001} & 0.19\\
Solitary TSD × Gender × Stimuli gender & 1, 319 & 1.78 & 0.18 & 0.0024\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\CommentTok{\# Moderators: Stimuli Gender \& Gender}
\NormalTok{slop.m2a\_lmer }\OtherTok{\textless{}{-}} \FunctionTok{sim\_slopes}\NormalTok{(m2a\_lmer,}
  ...
  \AttributeTok{modx =}\NormalTok{ Stimuli.gender, }\CommentTok{\# First moderator: Stimuli gender}
...
\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{rename}\NormalTok{(}\StringTok{"Stimuli.gender"} \OtherTok{=} \StringTok{"Value of Stimuli.gender"}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{slop.m2a\_lmer.tab[, }\SpecialCharTok{{-}}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{8}\NormalTok{)] }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{kable}\NormalTok{(}
    ...
    \AttributeTok{linesep =} \StringTok{""}\NormalTok{,}
    \AttributeTok{caption =} \StringTok{"Slope for Solitary TSD on Subjective Sexual Arousal by Stimuli Gender and Gender"}\NormalTok{,}
    \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Stimuli gender"}\NormalTok{, }\StringTok{"$B$"}\NormalTok{, }\StringTok{"$2.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$97.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$t$"}\NormalTok{, }\StringTok{"$p$"}\NormalTok{),}
    \AttributeTok{escape =} \ConstantTok{FALSE}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h2a-1.pdf}}
...
Stimuli gender & 1 & 18.293 & \textbf{< 0.0001} & 1 & 7.365 & \textbf{0.0067} & 1, 373.93 & 2.689 & 0.1\\
Dyadic TSD Attractive Person × Gender & 1 & 3.774 & 0.05 & 1 & 0.940 & 0.33 & 1, 319 & 0.530 & 0.47\\
Dyadic TSD Attractive Person × Stimuli gender & 1 & 7.654 & \textbf{0.0057} & 1 & 7.507 & \textbf{0.0061} & 1, 319 & 15.428 & \textbf{< 0.001}\\
Gender × Stimuli gender & 1 & 124.186 & \textbf{< 0.0001} & 1 & 67.054 & \textbf{< 0.0001} & 1, 319 & 27.444 & \textbf{< 0.0001}\\
Dyadic TSD Attractive Person × Gender × Stimuli gender & 1 & 3.833 & 0.05 & 1 & 20.127 & \textbf{< 0.0001} & 1, 319 & 29.689 & \textbf{< 0.0001}\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/preds-m2b-1.pdf}}
...
\begin{Highlighting}[]
\CommentTok{\# Generate ANOVA{-}type table for the final LMM model}
\CommentTok{\# Summarizes the effects of Dyadic TSD Attractive Person on SSA across Gender and Stimuli Gender}
\FunctionTok{anova.sig.lmer}\NormalTok{(}
...
Stimuli gender & 1, 373.93 & 2.69 & 0.1 & 0.0045\\
Dyadic TSD Attractive Person × Gender & 1, 319 & 0.53 & 0.47 & < 0.0001\\
Dyadic TSD Attractive Person × Stimuli gender & 1, 319 & 15.43 & \textbf{< 0.001} & 0.0431\\
Gender × Stimuli gender & 1, 319 & 27.44 & \textbf{< 0.0001} & 0.08\\
Dyadic TSD Attractive Person × Gender × Stimuli gender & 1, 319 & 29.69 & \textbf{< 0.0001} & 0.08\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\CommentTok{\# This examines differences by stimuli gender and participant gender}
...
\NormalTok{  m2b\_lmer,}
  ...
  \AttributeTok{modx =}\NormalTok{ Stimuli.gender, }\CommentTok{\# Moderator: Stimuli gender}
  \AttributeTok{mod2 =}\NormalTok{ Gender, }\CommentTok{\# Second moderator: Gender}
  \AttributeTok{confint =} \ConstantTok{TRUE} \CommentTok{\# Compute confidence intervals}
\NormalTok{)}
...
\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{rename}\NormalTok{(}\StringTok{"Stimuli.gender"} \OtherTok{=} \StringTok{"Value of Stimuli.gender"}\NormalTok{, }\AttributeTok{Coefficient =}\NormalTok{ Est.)}
...
\NormalTok{slop.m2b\_lmer.tab[, }\SpecialCharTok{{-}}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{8}\NormalTok{)] }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{kable}\NormalTok{(}
    ...
    \AttributeTok{caption =} \StringTok{"Slope for Dyadic TSD Attractive Person on SSA by stimuli gender and gender"}\NormalTok{,}
    \AttributeTok{linesep =} \StringTok{""}\NormalTok{,}
    \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}\StringTok{"Stimuli gender"}\NormalTok{, }\StringTok{"$B$"}\NormalTok{, }\StringTok{"$2.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$97.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$t$"}\NormalTok{, }\StringTok{"$p$"}\NormalTok{),}
    \AttributeTok{escape =} \ConstantTok{FALSE}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h2b-1.pdf}}
...
Stimuli gender & 1 & 10.881 & \textbf{< 0.001} & 1 & 2.688 & 0.1 & 1, 344.42 & 0.991 & 0.32\\
Dyadic TSD Partner × Gender & 1 & 0.310 & 0.58 & 1 & 2.111 & 0.15 & 1, 316 & 3.967 & \textbf{0.0472}\\
Dyadic TSD Partner × Stimuli gender & 1 & 2.366 & 0.12 & 1 & 5.423 & \textbf{0.0199} & 1, 316 & 8.458 & \textbf{0.0039}\\
Gender × Stimuli gender & 1 & 61.739 & \textbf{< 0.0001} & 1 & 45.783 & \textbf{< 0.0001} & 1, 316 & 20.549 & \textbf{< 0.0001}\\
Dyadic TSD Partner × Gender × Stimuli gender & 1 & 1.254 & 0.26 & 1 & 2.461 & 0.12 & 1, 316 & 5.700 & \textbf{0.0176}\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/preds-m2c-1.pdf}}
...
\begin{table}[H]
\centering
\caption{\label{tab:tab-m2c}Effects of Dyadic TSD Partner on SSA Across Gender and Stimuli Gender}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccc}
...
Stimuli gender & 1, 344.42 & 0.99 & 0.32 & < 0.0001\\
Dyadic TSD Partner × Gender & 1, 316 & 3.97 & \textbf{0.0472} & 0.0093\\
Dyadic TSD Partner × Stimuli gender & 1, 316 & 8.46 & \textbf{0.0039} & 0.023\\
Gender × Stimuli gender & 1, 316 & 20.55 & \textbf{< 0.0001} & 0.06\\
Dyadic TSD Partner × Gender × Stimuli gender & 1, 316 & 5.70 & \textbf{0.0176} & 0.0146\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\NormalTok{  m2c\_lmer,}
  ...
  \AttributeTok{modx =}\NormalTok{ Stimuli.gender,}
...
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{rename}\NormalTok{(}
    \StringTok{"Stimuli.gender"} \OtherTok{=} \StringTok{\textasciigrave{}}\AttributeTok{Value of Stimuli.gender}\StringTok{\textasciigrave{}}\NormalTok{,}
...
\StringTok{    stimuli gender and gender"}\NormalTok{,}
    \AttributeTok{linesep =} \StringTok{""}\NormalTok{,}
    \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}
      \StringTok{"Stimuli gender"}\NormalTok{, }\StringTok{"$B$"}\NormalTok{, }\StringTok{"$2.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$97.5}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\% CI$"}\NormalTok{, }\StringTok{"$t$"}\NormalTok{, }\StringTok{"$p$"}
\NormalTok{    ),}
    \AttributeTok{escape =} \ConstantTok{FALSE}
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{latex\_options =} \FunctionTok{c}\NormalTok{(}\StringTok{"HOLD\_position"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h2c-1.pdf}}
...
Effect & $df$ & $\chi^2$ & $p$ & $df$ & $\chi^2$ & $p$ & $df$ & $F$ & $p$\\
\midrule
Solitary TSD & 1 & 10.812 & \textbf{0.001} & 1 & 9.473 & \textbf{0.0021} & 1, 315 & 6.881 & \textbf{0.0091}\\
Gender & 1 & 18.645 & \textbf{< 0.0001} & 1 & 17.941 & \textbf{< 0.0001} & 1, 355.34 & 14.100 & \textbf{< 0.001}\\
Relationship & 1 & 0.001 & 0.97 & 1 & 0.018 & 0.89 & 1, 314.95 & 0.337 & 0.56\\
Solitary TSD × Gender & 1 & 1.554 & 0.21 & 1 & 1.291 & 0.26 & 1, 315.23 & 0.071 & 0.79\\
Solitary TSD × Relationship & 1 & 0.071 & 0.79 & 1 & 0.180 & 0.67 & 1, 314.95 & 0.531 & 0.47\\
Gender × Relationship & 1 & 3.058 & 0.08 & 1 & 2.152 & 0.14 & 1, 314.95 & 2.953 & 0.09\\
Solitary TSD × Gender × Relationship & 1 & 2.343 & 0.13 & 1 & 1.443 & 0.23 & 1, 315.08 & 2.023 & 0.16\\
\bottomrule
\end{tabular}
\begin{tablenotes}[para]
\item \textit{Note: } 
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/preds-m3a-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h3a-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/preds-m3b-1.pdf}}
...
\StringTok{        Subjective sexual arousal by stimuli gender and gender"}\NormalTok{,}
    \AttributeTok{linesep =} \StringTok{""}\NormalTok{,}
    \AttributeTok{col.names =} \FunctionTok{c}\NormalTok{(}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h3b-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/preds-m3c-1.pdf}}
...
\begin{table}[H]
\centering
\caption{\label{tab:tab-m3c}Effects of Dyadic TSD Partner on SSA Across Gender and Stimuli Gender}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccc}
...
\StringTok{               by stimuli gender and gender"}\NormalTok{,}
    \AttributeTok{linesep =} \StringTok{""}\NormalTok{,}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-h3c-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-m1-fin-1.pdf}}
...
\NormalTok{) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{kable}\NormalTok{(}
    ...
    \AttributeTok{caption =} \StringTok{"Effects of TSD dimensions on SSA Across Gender and Stimuli Gender"}\NormalTok{,}
...
\NormalTok{  ) }\SpecialCharTok{|\textgreater{}}
  ...
  \FunctionTok{footnote}\NormalTok{(}
    \AttributeTok{general =} \FunctionTok{paste0}\NormalTok{(}
      ...
      \StringTok{". Gender = participant gender (women, men); Stimuli gender = gender of stimuli (male, female).}
...
\begin{table}[H]
\centering
\caption{\label{tab:tab-m2-fin}Effects of TSD dimensions on SSA Across Gender and Stimuli Gender}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
\begin{tabular}[t]{lcccc}
...
\hspace{1em}Stimuli gender & 1, 369.21 & 24.71 & \textbf{< 0.0001} & 0.06\\
\hspace{1em}Solitary TSD × Gender & 1, 319 & 0.85 & 0.36 & < 0.0001\\
\hspace{1em}Solitary TSD × Stimuli gender & 1, 319 & 0.02 & 0.88 & < 0.0001\\
\hspace{1em}Gender × Stimuli gender & 1, 319 & 74.79 & \textbf{< 0.0001} & 0.19\\
\hspace{1em}Solitary TSD × Gender × Stimuli gender & 1, 319 & 1.78 & 0.18 & 0.0024\\
\addlinespace[0.3em]
...
\hspace{1em}Stimuli gender & 1, 373.93 & 2.69 & 0.1 & 0.0045\\
\hspace{1em}Dyadic TSD Attractive Person × Gender & 1, 319 & 0.53 & 0.47 & < 0.0001\\
\hspace{1em}Dyadic TSD Attractive Person × Stimuli gender & 1, 319 & 15.43 & \textbf{< 0.001} & 0.0431\\
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-m2-fin-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Supplementary-Material_files/figure-latex/fig-m3-fin-1.pdf}}
